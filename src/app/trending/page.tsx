...
function TrendingRow({ token }: { token: TrendingToken }) {
  ...
  return (
    <tr className="border-b border-orange-500 hover:bg-orange-600 transition-colors">
      <td className="px-5 py-2 text-sm sticky left-0 z-10 min-w-[150px] border-r border-orange-600">
      ...
      <td className="px-5 py-2 text-sm min-w-[120px] border-r border-orange-600">
        <span
      ...
      <td className="px-5 py-2 text-xs min-w-[120px] border-r border-orange-600">
                ...
                <table className="w-full min-w-[600px]">
                  <thead>
                    <tr className="bg-orange-500">
                      <th className="text-md font-semibold text-white uppercase tracking-wider px-5 py-3 text-left sticky left-0 bg-orange-500 z-20 min-w-[150px] border-r border-orange-600">Token</th>
                      <th className="text-md font-semibold text-white uppercase tracking-wider px-5 py-3 text-left min-w-[120px] border-r border-orange-600">Price</th>
                      <th className="text-md font-semibold text-white uppercase tracking-wider px-5 py-3 text-left min-w-[120px] border-r border-orange-600">24H Change</th>
                      <th className="text-md font-semibold text-white uppercase tracking-wider px-5 py-3 text-left min-w-[120px] border-r border-orange-600">Market Cap</th>
                      <th className="text-md font-semibold text-white uppercase tracking-wider px-5 py-3 text-left min-w-[120px] border-r border-orange-600">Liquidity</th>
